...
export class GenericService {
  ...
  protected post<T>(endpoint: string, payload: any, headers?: HttpHeaders): Observable<T> {
    return this.http.post<T>(`${this.baseUrl}${endpoint}`, payload, { headers });
  }

  protected put<T>(endpoint: string, payload: any, headers?: HttpHeaders): Observable<T> {
