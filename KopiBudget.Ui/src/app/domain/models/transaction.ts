...
export class Transaction {
    ...
    typeValidator(formGroup: FormGroup) {
        ...
        formGroup.get('category')?.setErrors(
            !formGroup.get('category')?.value ? { required: true } : null
        );
        formGroup.get('categoryId')?.setErrors(
            !formGroup.get('categoryId')?.value ? { required: true } : null
        );
        formGroup.get('account')?.setErrors(
            !formGroup.get('account')?.value ? { required: true } : null
        );
        formGroup.get('accountId')?.setErrors(
            !formGroup.get('accountId')?.value ? { required: true } : null
        );
    }
    else if (type === TransactionTypes.BUDGET) {
        formGroup.get('budget')?.setErrors(
            !formGroup.get('budget')?.value ? { required: true } : null
        );
        formGroup.get('budgetId')?.setErrors(
            !formGroup.get('budgetId')?.value ? { required: true } : null
        );
        formGroup.get('personalCategory')?.setErrors(
            !formGroup.get('personalCategory')?.value ? { required: true } : null
        );
        formGroup.get('personalCategoryId')?.setErrors(
            !formGroup.get('personalCategoryId')?.value ? { required: true } : null
        );
        formGroup.get('budgetId')?.setErrors(
            !formGroup.get('budgetId')?.value ? { required: true } : null
        );
